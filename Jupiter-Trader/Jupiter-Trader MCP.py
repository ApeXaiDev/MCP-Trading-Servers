...
app = FastAPI(
    title="ApeXai Jupiter Trader",
    description="An ApeXai server for executing token swaps on the Solana blockchain using Jupiter's Ultra API.",
    version="0.1.0",
)

@app.get("/apexai/trade/jupiter")
async def swap_tokens_jupiter(
    ...
    Intended for use in the ApeXai ecosystem.
    """
